  ...
  return (
    <div className="flex flex-col relative">
      <div className="absolute top-0 left-0 w-full h-full">
        <img src="/src/assets/Icons/icone3.png" className='w-[120px] md:w-[150px] absolute left-[50%] translate-x-[-50%] top-0 md:top-[30px]'/>
        <img src="/src/assets/Icons/icone1.png" className='w-[60px] md:w-[80px] absolute right-0 top-[200px]'/>
        <img src="/src/assets/Icons/icone2.png" className='w-[120px] absolute left-[-20px] top-[160px]'/>
      </div>
